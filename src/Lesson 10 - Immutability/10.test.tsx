import { UserType, UserWithBooksType, UserWithLaptopType, WithCompaniesType, addBooksToUser, addCompany, makeHairstyle, moveUser, moveUserToOtherHouse, removeBook, updateBook, upgradeUserLaptop } from "./10"
